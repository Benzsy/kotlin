...
internal object SwiftExportConstants {
    ...
    /**
     * The Swift code generated by Swift Export uses APIs that Apple shipped in these OS versions, `Synchronization.Mutex`
     * among them. Building the generated package against an older deployment target does not compile.
     */
    val minimumDeploymentTargets: Map<Family, String> = mapOf(
        Family.IOS to "18.0",
        Family.OSX to "15.0",
        Family.TVOS to "18.0",
        Family.WATCHOS to "11.0",
    )
}
