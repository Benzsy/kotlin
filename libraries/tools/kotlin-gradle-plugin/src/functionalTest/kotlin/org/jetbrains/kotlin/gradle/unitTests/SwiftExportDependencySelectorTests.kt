...
class SwiftExportDependencySelectorTests {
    ...
    /**
     * A real [org.gradle.api.artifacts.component.ProjectComponentIdentifier], obtained by resolving a project
     * dependency, because the interface grows methods across Gradle versions and a hand-rolled double would
     * not compile against all of them.
     */
