...
public class KaPiece<T> internal constructor() {
    ...
    public companion object {
         ...
         */
        public val TypeParameterList: KaPiece<KaDeclarationSymbol> = KaPiece()
         ...
         */
        public val WhereClause: KaPiece<KaDeclarationSymbol> = KaPiece()

        /**
         * The `context(...)` clause of a callable, followed by a line break or a space (see
         * [KaRenderingOption.ContextReceiversOnNewLine]). Nothing is rendered when there are no context parameters.
         */
        public val ContextParameterList: KaPiece<KaCallableSymbol> = KaPiece()
        ...
        public val ValueParameterList: KaPiece<KaFunctionSymbol> = KaPiece()
